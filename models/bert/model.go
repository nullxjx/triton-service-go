...
func (m *ModelService) generateHTTPInputs(
	inferDataArr []string, inferInputs []*triton.ModelInferRequest_InferInputTensor,
...
func (m *ModelService) generateGRPCRequest(
	inferDataArr []string,
	inferInputTensor []*triton.ModelInferRequest_InferInputTensor,
) ([][]byte, []*InputObjects) {
...
) (*triton.ServerMetadataResponse, error) {
...
func (m *ModelService) GetModelMeta(
	modelName, modelVersion string, requestTimeout time.Duration,
) (*triton.ModelMetadataResponse, error) {
...
) (*triton.RepositoryIndexResponse, error) {
...
func (m *ModelService) GetModelInferStats(
	modelName, modelVersion string, requestTimeout time.Duration,
) (*triton.ModelStatisticsResponse, error) {
...
func NewModelService(
	...
	srv := &ModelService{
		...
		tritonService:                   triton.NewTritonClientForAll(httpAddr, httpClient, grpcConn),
